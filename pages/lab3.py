...
class DrawLab3(ctk.CTkFrame):
    ...
    def text_encrypt(self):
        ...
        result = rc5.encryptBytes(text_to_encrypt)
    ...
    def text_decrypt(self):
        ...
        result = rc5.decryptBytes(text_to_encrypt)
    ...
    def file_encrypt(self):
        ...
        rc5.encryptFile(file_to_encrypt, output_file)
    ...
    def file_decrypt(self):
        ...
        rc5.decryptFile(file_to_encrypt, output_file)
